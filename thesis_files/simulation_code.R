...
results <- parSim(
    ...
    expression = {
        ...
        correction <- IsingFit_sumscore_corr(selection, progressbar = FALSE, plot = FALSE, min_sumscore = cutoff)$weiadj
...
correction <- correction_thresh(large_severe_pop, sumscore = 5, plot = FALSE, progressbar = FALSE)$weiadj
